"""
urukuls set to use clock from MMCX at 125 MHz.
The calibration of sync_delay_seed and io_update_delay was done using an external 125 MHz clock for the Kasli,
i.e. rtio_clock = ext0_bypass in the config file, and a 125 MHz ref delivered to the front panel.
"""
