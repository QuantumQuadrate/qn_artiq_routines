...
device_db["urukul0_cpld"] = {
    ...
    "arguments": {
        ...
        "sync_device": "ttl_urukul0_sync", # should fix no valid window/delay according to https://github.com/m-labs/artiq/issues/1194, but doesn't
        "clk_div": 1,  # PH added this
        "refclk": 1e7,  # 125000000.0,
        "clk_sel": 1
    }
}
