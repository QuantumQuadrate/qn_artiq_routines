"""
urukuls set to use external clock at 125 MHz from front panel.
The MMCX cables are connected, but should be ignored. If the sync_delay_seed and
io_update_delay are set to EEPROM strings (they are commented out),
then the calibration in the urukul tester will fail with a no valid window/delay error
raised in AD9910.tune_sync_delay. Without sync_delay_seed or io_update_delay set, the
calibration is ignored and reports no EEPROM synchronization.
"""

### Autogenerated for the wisc variant
...
device_db["urukul0_cpld"] = {
    ...
    "arguments": {
        ...
        "refclk": 125000000.0,
        "clk_sel": 1  # external, front panel SMA
    }
}
