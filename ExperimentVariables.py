...
class ExperimentVariables(EnvExperiment):
    ...
    def build(self):
        ...
        self.vars_list = [
            ...
            Variable("p_FORT_RO", 0.8, NumberValue, {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'ndecimals': 1},
                     "FORT AOM"),
            ...
            Variable("f_cooling_DP_RO", 115.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_PGC", 120.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            ...
            Variable("f_pumping_repump", 345.10 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "OP and excitation AOMs"),
            Variable("p_pumping_repump", -10.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "OP and excitation AOMs"),
            ...
            Variable("f_microwaves_00_dds", 334.682 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_01_dds", 338.205 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_11_dds", 341.73 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_m10_dds", 341.73 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            ...
            Variable("t_microwave_pulse", 4.5 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_microwave_00_pulse", 16.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_microwave_01_pulse", 60.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_microwave_11_pulse", 6.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_microwave_m10_pulse", 6.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_2MHz_RF_pulse", 1000.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_MW_00_ramp", 2 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_MW_01_ramp", 4 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_MW_11_ramp", 2 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_pi_microwave_pulse", 4.5 * us, NumberValue, {'type': 'float', 'unit': 'us', 'ndecimals': 3}, "Timing"),
