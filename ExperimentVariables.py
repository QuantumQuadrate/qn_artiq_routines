...
class ExperimentVariables(EnvExperiment):
    ...
    def build(self):
        ...
        self.vars_list = [
            ...
            Variable("t_microwave_00_pulse", 4.5 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("t_microwave_01_pulse", 24.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            ...
            Variable("t_UV_pulse", 20 * ms, NumberValue, {'type': 'float', 'unit': 'ms'}, "Timing"),
            ...
            Variable('set_point_FORT_APD_loading', 0.06, NumberValue, {'type': 'float', 'ndecimals': 3}, "Set points"),
