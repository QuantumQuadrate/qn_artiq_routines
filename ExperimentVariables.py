...
class ExperimentVariables(EnvExperiment):
    ...
    def build(self):
        ...
        self.vars_list = [
            ...
            Variable("n_measurements", 50, NumberValue, {'type': 'int', 'precision':0, 'step':1, 'scale':1}, "general"),
            ...
            Variable("n_excitation_attempts", 10, NumberValue, {'type': 'int', 'precision': 0, 'step': 1, 'scale': 1},
                     "single photon experiment"),
            Variable("n_excitation_cycles", 10, NumberValue, {'type': 'int', 'precision': 0, 'step': 1, 'scale': 1},
                     "single photon experiment"),
            ...
            Variable("p_FORT_loading", -4, NumberValue,
                     {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1}, "FORT AOM"),
            Variable("p_FORT_RO", 1, NumberValue, {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'precision': 1},
                     "FORT AOM"),
            Variable("p_FORT_holding", 1, NumberValue,
                     {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'precision': 2},
                     "FORT AOM"),
            Variable("p_FORT_PGC", 1, NumberValue, {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'precision': 2},
                     "FORT AOM"),
            ...
            Variable("f_cooling_DP_blowaway", 112.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("p_cooling_DP_MOT", -4, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Cooling double pass AOM"),
            ...
            Variable("f_D1_pumping_DP", 368 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "OP and excitation AOMs"),
            Variable("p_D1_pumping_DP", -9.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "OP and excitation AOMs"),
            Variable("f_pumping_repump", 345.10 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "OP and excitation AOMs"),
            Variable("p_pumping_repump", -8.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "OP and excitation AOMs"),
            Variable("f_excitation", 150.50 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "OP and excitation AOMs"),
            Variable("p_excitation", -8.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "OP and excitation AOMs"),

            # Fiber AOMs
            Variable("AOM_A1_freq", 78.5 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A1", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),
            Variable("AOM_A2_freq", 78.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A2", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),
            Variable("AOM_A3_freq", 78.503 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A3", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),
            Variable("AOM_A4_freq", 78.504 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A4", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),
            Variable("AOM_A5_freq", 78.505 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A5", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),
            Variable("AOM_A6_freq", 78.506 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A6", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Fiber AOMs"),

            # # Pumping Repump
            # Variable("p_pumping_repump_A5", -20.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
            #          "Fiber AOMs"),
            # Variable("p_pumping_repump_A6", -8.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
            #          "Fiber AOMs"),


            # Microwaves
            # assumes the microwave source is set at 6.5 GHz
            Variable("f_microwaves_dds", 334.682 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'precision': 7},
                     "Microwaves"),
            Variable("p_microwaves", 0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'precision': 1},
                     "Microwaves"),

            # Coils - MOT
            Variable("AZ_bottom_volts_MOT", 4.896, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AZ_top_volts_MOT", 5.405, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AX_volts_MOT", 0.419, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AY_volts_MOT", 0.255, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),

            Variable("AZ_bottom_volts_MOT_phase2", 4.896, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "MOT coil settings"),
            Variable("AZ_top_volts_MOT_phase2", 5.405, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "MOT coil settings"),
            Variable("AX_volts_MOT_phase2", 0.419, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "MOT coil settings"),
            Variable("AY_volts_MOT_phase2", 0.255, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "MOT coil settings"),

            # Coils - PGC
            Variable("AZ_bottom_volts_PGC", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AZ_top_volts_PGC", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AX_volts_PGC", -0.11, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AY_volts_PGC", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),

            # Coils - Readout
            Variable("AZ_bottom_volts_RO", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AZ_top_volts_RO", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AX_volts_RO", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),
            Variable("AY_volts_RO", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision':3},
                     "MOT coil settings"),

            # Coils - state prep and science
            Variable("AZ_bottom_volts_OP", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AZ_top_volts_OP", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AX_volts_OP", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            # about 1 G along the parabolic mirror axis.
            Variable("AY_volts_OP", 2.105, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AZ_bottom_volts_blowaway", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AZ_top_volts_blowaway", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AX_volts_blowaway", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            # about 1 G along the parabolic mirror axis.
            Variable("AY_volts_blowaway", 2.105, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AZ_bottom_volts_microwave", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AZ_top_volts_microwave", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            Variable("AX_volts_microwave", 0.0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            # about 1 G along the parabolic mirror axis.
            Variable("AY_volts_microwave", 0, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Science coil settings"),
            ...
            Variable("t_pi_microwave_pulse", 1.494 * us, NumberValue, {'type': 'float', 'unit': 'us', 'precision': 3}, "Timing"),
            ...
            Variable("gate_start_offset_mu", 0, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1, 'step':1},
                     "Timing"),
            Variable("gate_switch_offset", 0*ns, NumberValue, {'type': 'int', 'unit':'ns',
                                                            'precision': 0, 'scale': 1, 'step': 1},
                     "Timing"),
            ...
            # Set points
            Variable("set_point_PD1_AOM_A1", 0.427, NumberValue, {'type':'float','precision':3}, "Set points"),
            Variable("set_point_PD2_AOM_A2", 0.148, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable("set_point_PD3_AOM_A3", 0.293, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable("set_point_PD4_AOM_A4", 0.286, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable("set_point_PD5_AOM_A5", 0.214, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable("set_point_PD6_AOM_A6", 0.296, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable('set_point_FORT_APD_loading', 0.051, NumberValue, {'type': 'float', 'precision': 3}, "Set points"),
            Variable('set_point_FORT_APD_science', 0.04, NumberValue, {'type': 'float', 'precision': 3}, "Set points"),
            Variable('set_point_FORT_MM_loading', 0.272, NumberValue, {'type': 'float','precision':3}, "Set points"),
            Variable('set_point_FORT_MM_science', 0.2, NumberValue, {'type': 'float', 'precision': 3}, "Set points"),
            Variable('set_point_D1_SP', 0.175, NumberValue, {'type': 'float', 'precision': 3}, "Set points"),
            Variable('set_point_excitation', 1.0, NumberValue, {'type': 'float', 'precision': 3}, "Set points"),

            # Plotting
            Variable("MOT_beam_monitor_points", 100, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1, 'step':1},
                     "Plotting"),
            Variable("ignore_first_n_histogram_points", 10, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1,
                     'step': 1}, "Plotting"),
            Variable("FORT_MM_monitor_sci_ref_volts", 0.25, NumberValue, {'type': 'float', 'precision': 3, 'scale': 1,
                                                                          'step': 0.05}, "Plotting"),
            ...
            Variable("aom_feedback_averages", 4, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1, 'step':1},
                     "Laser feedback"),
            Variable("aom_feedback_iterations", 4, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1, 'step':1},
                     "Laser feedback"),
            Variable("Rigol_carrier_frequency", 40 * kHz, NumberValue, {'type': 'float', 'unit': 'kHz', 'precision': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_FM_deviation", 10 * kHz, NumberValue, {'type': 'float', 'unit': 'kHz', 'precision': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_V_DC", 0.595, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_V_pp", 0.03, NumberValue, {'type': 'float', 'unit': 'V', 'precision': 3},
                     "Rigol DG1022Z settings"),
            Variable("f_Rigol_modulation", 10 * kHz, NumberValue, {'type': 'float', 'unit': 'kHz', 'precision': 3},
                     "Rigol DG1022Z settings"),
            # Thorlabs Devices
            Variable("K10CR1_FORT_HWP_SN", 55000759, NumberValue, {'type': 'int', 'precision': 0, 'scale': 1, 'step':1},
                     "Thorlabs Devices"),
            Variable("K10CR1_FORT_QWP_SN", 55000740, NumberValue,
                     {'type': 'int', 'precision': 0, 'scale': 1, 'step': 1},
                     "Thorlabs Devices"),
            ...
            Variable("hwp_move_by_deg", 0, NumberValue,
                     {'type': 'float', 'precision': 2, 'scale': 1, 'step': 0.5},
                     "Thorlabs Devices"),
            ...
            Variable("best_852HWP_to_max", 0, NumberValue,
                     {'type': 'float', 'precision': 3, 'scale': 1, 'step': 0.5},
                     "Thorlabs Devices"),
