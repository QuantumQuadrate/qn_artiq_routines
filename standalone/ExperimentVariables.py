...
class ExperimentVariables(EnvExperiment):
    ...
    def build(self):
        ...
        self.vars_list = [
            ...
            Variable("t_SPCM_test_shot", 10 * ms, NumberValue, {'type': 'float', 'unit': 'ms'}, "Timing"),
            ...
            Variable('set_point_FORT_APD_holding', 0.1, NumberValue, {'type': 'float', 'ndecimals': 5}, "Set points"),
        ...
        self.setattr_argument('which_node', EnumerationValue(['bob', 'alice']), "general")
