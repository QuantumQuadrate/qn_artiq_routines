...
class AOMs_Coils(EnvExperiment):
    def build(self):
        ...
        self.setattr_argument("AOM_A2_power", NumberValue(0, unit="dBm", scale=1, precision=1), "AOM A2")
        ...
        self.setattr_argument("AOM_A5_power", NumberValue(0, unit="dBm", scale=1, precision=1), "AOM A5")
        ...
        self.setattr_argument("AZ_top_volts_MOT", NumberValue(-2.5, unit="V", precision=3, step=0.01),
                              "A-Z shim/quad top coil")
        self.setattr_argument("AX_volts_MOT", NumberValue(-0.19, unit="V", precision=3, step=0.01), "A-X shim coils")
        self.setattr_argument("AY_volts_MOT", NumberValue(-0.25, unit="V", precision=3, step=0.01), "A-Y shim coils")
