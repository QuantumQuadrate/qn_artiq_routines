...
class SimpleAtomTrapping(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument("AZ_top_volts_MOT", NumberValue(1.8*(-1.64/2.5), unit="V", precision=3, step=0.025), "A-Z shim/quad top coil")
        self.setattr_argument("AZ_top_volts_PGC", NumberValue(0 * (-1.64 / 2.5), unit="V", precision=3, step=0.025), "A-Z shim/quad top coil")
        self.setattr_argument("AZ_top_volts_RO", NumberValue(0 * (-1.64 / 2.5), unit="V", precision=3, step=0.025), "A-Z shim/quad top coil")
        self.setattr_argument("AZ_bottom_volts_MOT", NumberValue(-1.75*(-1.64/2.5), unit="V", precision=3, step=0.025), "A-Z shim/quad bottom coils")
        ...
        self.setattr_argument("AX_volts_MOT", NumberValue(0.5*(-1.64/2.5), unit="V", precision=3, step=0.025),"A-X shim coils")
        ...
        self.setattr_argument("AY_volts_MOT", NumberValue(0.4*(-1.64/2.5), unit="V", precision=3, step=0.025),"A-Y shim coils")
        ...
        self.setattr_argument("t_MOT_loading", NumberValue(350 * ms, unit="ms", precision=0, step=10 * ms))
        self.setattr_argument("t_FORT_loading", NumberValue(100 * ms, unit="ms", precision=1, step=10 * ms))
