...
class XYPlot(pyqtgraph.PlotWidget):
    def __init__(self, args):
        ...
        self.labels = ["health_check_uw_freq00", "health_check_uw_freq01", "health_check_uw_freq11", "health_check_uw_freqm10", "health_check_uw_freqm11"]
...
def main():
    ...
    applet.add_dataset("health_check_uw_freqm11", "health_check_uw_freqm11")
