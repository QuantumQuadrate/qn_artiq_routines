...
class XYPlot(pyqtgraph.PlotWidget):
    ...
    def data_changed(self, data, mods, title):
        ...
        if y0 is not None:
            ...
            # if fit is not None:
            #     fit /= y0
            y1 /= y2   ###normalied power to setpoint
...
def main():
    ...
    applet.add_dataset("y1", "y1 value. FORT APD monitor", required=False)
    applet.add_dataset("y2", "y2 value. FORT APD loading setpoint", required=False)
