"""
Similar to GeneralVariableScan.py but with catching Underflow error. We need some management of Underlow in the experiment
to use this Catch effectively. This helps to catch OCCASIONAL Underflow errors.
